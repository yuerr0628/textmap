...
from psdet.utils.utils import crop_margin, fixed_ROI
from psdet.models.Customized import CustomizedAlexNet
...
class vpsClassify(object):
    ...
    def image_preprocess(self, img, pts):
        ...
        warp_img = cv2.warpPerspective(roi_img, m_warp, (512, 512))
