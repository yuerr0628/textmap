...
mapText::mapText(ros::NodeHandle& nh): vehiclepose(nh) {
    
    image_sub = nh.subscribe("/driver/fisheye/avm/compressed", 10, &mapText::imageCallback,this);
...
void mapText::imageCallback(const sensor_msgs::CompressedImageConstPtr& msg)
{
